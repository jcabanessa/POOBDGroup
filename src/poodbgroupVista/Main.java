...
public class Main {
    ...
    private void anyadirPedido() {
        try {
            ...
            try {
                // Intentar añadir el pedido
                controlador.addPedido(numPedido, cantidad, fecha, codArticulo, emailCliente);
                System.out.println("Pedido registrado correctamente.");

            } catch (TiendaException e) {
                // Si el error es porque el cliente no existe, crearlo
                if (e.getMessage().equals("Cliente no encontrado")) {
                    ...
                    // Añadir el cliente al sistema
                    controlador.addCliente(nuevoCliente);
                    System.out.println("Cliente añadido correctamente.");

                    // Intentar nuevamente añadir el pedido
                    controlador.addPedido(numPedido, cantidad, fecha, codArticulo, emailCliente);
