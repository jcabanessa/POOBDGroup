...
-- Procedimiento almacenado: calcula el precio total de un pedido
DELIMITER / /

CREATE PROCEDURE calcularTotalPedido(IN p_num_pedido VARCHAR(50), OUT p_total DECIMAL(10,2))
BEGIN
    SELECT (p.cantidad * a.precio_venta) + a.gastos_envio
    INTO p_total
    FROM pedido p
